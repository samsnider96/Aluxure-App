class Item < ActiveRecord::Base
  ...
  validates_presence_of :brand, :category, :color, :condition, :description, :image_upload_id, :gender, :material
  validates_presence_of :size, :if => :is_not_suit?
  ...
  def is_not_suit?
    return true unless category == "Suits"
    false
  end
